...
exports.CiudadServicio = void 0;
const common_1 = require("@nestjs/common");
let CiudadServicio = class CiudadServicio {
    constructor() {
        this.localidadesBogota = [
            {
                nombre: "Chapinero",
                ...
                imagenRef: "https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/SY4JRRQ5AAI6VF32CWTHCDWW3I.jpg",
            ...
            },
            {
                ...
                imagenRef: "https://static.roadtrip.travel/media/roadtrips/senderismo-urbano-historia-y-arquitectura-de-teusaquillo-1200-cbdcf9c.jpg",
    ...
    getLocalidadesDatos(nombre) {
        const localidad = this.localidadesBogota.find((l) => l.nombre.toLowerCase() === nombre.toLowerCase());
        if (!localidad) {
...
exports.CiudadServicio = CiudadServicio;
exports.CiudadServicio = CiudadServicio = __decorate([
